...
import com.team2502.robot2018.command.teleop.ClimberCommand;
...
public final class OI
{
    ...
    public static final Button INTAKE_IN = new DebouncedJoystickButton(JOYSTICK_FUNCTION, RobotMap.Joystick.Button.INTAKE_IN);
    public static final Button INTAKE_OUT = new DebouncedJoystickButton(JOYSTICK_FUNCTION, RobotMap.Joystick.Button.INTAKE_OUT);
    public static final Button OPEN_INTAKE = new DebouncedJoystickButton(JOYSTICK_FUNCTION, RobotMap.Joystick.Button.OPEN_INTAKE);

    public static final Button ELEV_UP = new DebouncedJoystickButton(JOYSTICK_FUNCTION, RobotMap.Joystick.Button.RAISE_ELEVATOR);
    public static final Button ELEV_DOWN = new DebouncedJoystickButton(JOYSTICK_FUNCTION, RobotMap.Joystick.Button.LOWER_ELEVATOR);

    public static final Button CLIMBER = new DebouncedJoystickButton(JOYSTICK_FUNCTION, RobotMap.Joystick.Button.CLIMBER);
//    public static final Button CLIMBER_DOWN = new JoystickButtonF(JOYSTICK_FUNCTION, RobotMap.UNDEFINED);


    public static final Button SHIFT_GEARBOX_ELEV = new DebouncedJoystickButton(JOYSTICK_FUNCTION, RobotMap.Joystick.Button.SHIFT_GEARBOX_ELEV);
