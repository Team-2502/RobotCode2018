...
public class RobotMap
{
    ...
    public static final class Motor
    {
        ...
        public static final double POS_TO_FEET = (WHEEL_DIAMETER * Math.PI) / (4096 * 12);
        public static final double VEL_TO_RPM = (600 / 4096);
        public static final double VEL_TO_FPS = VEL_TO_RPM * (Math.PI / 2); /* VEL_TO_RPM * (6 * Math.PI / 12) */
