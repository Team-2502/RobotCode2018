 ...
 */
public class PlsWorkLocalizer implements ITranslationalLocationEstimator, ITranslationalVelocityEstimator
{
    private ImmutableVector2f location;
    private IRotationalLocationEstimator rotEstimator;
    private IStopwatch stopwatch;

    public PlsWorkLocalizer(IRotationalLocationEstimator rotEstimator)
    {
